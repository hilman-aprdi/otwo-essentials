      ...
      <div className="container relative mx-auto max-w-7xl px-6">
        ...
        <div className="relative z-10 mt-10 border-t border-white/15 pt-8 text-center text-gray-400">
          <p className="mb-6 flex items-center justify-center gap-4">
            <a href="https://www.instagram.com/o2essentials.id/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram">
            ...
            <a href="https://shopee.co.id/o2essentialsofficialstore" target="_blank" rel="noopener noreferrer" aria-label="Shopee" title="Shopee">
            ...
            <a href="https://tokopedia.link/nVz9s1vp9Ub" target="_blank" rel="noopener noreferrer" aria-label="Tokopedia" title="Tokopedia">
            ...
            <a href="https://www.tiktok.com/@o2essentials" target="_blank" rel="noopener noreferrer" aria-label="TikTok" title="TikTok">
